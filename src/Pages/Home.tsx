...
function Home() {
    return (
        <div id ="Info1">
            ...
            <Link className="Album" to="/game">Click to play our game</Link>
          
            <img src={require("../Assets/Images/dubai.jpg")} id="Dubai" alt="logo" />
            
            
            <h2>You have to be logged in before playing this game<br></br><br></br></h2>
            ...
            <div id ="Info2">
                ...
                <h3>What were our sources of inspiration and how was this project born?</h3>
                <p>
